...
class Block5TextTokenizer:
    ...
    def audio_open_id(self, audio_idx: int) -> int:
        ...
        if not isinstance(audio_idx, int):
            raise TypeError("audio_idx must be an int")
        if not (1 <= audio_idx <= MAX_AUDIOS):
    ...
    def build_training_target(
        ...
        """
        # Validate stage parameter early to reject invalid values like 0 or 5
